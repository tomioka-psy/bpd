...
ご家族が現実的な目標設定・家庭環境づくり・危機対応・問題解決・限界設定を学ぶための
ガイドラインです。

## 権利・許可について

- 原著 *Family Guidelines* の権利は NEA-BPD（現 [BPD Alliance](https://bpdalliance.org/)）に帰属します。原文は同サイト内の Resources から閲覧できます。
- 本日本語版は、NEA-BPD（現 BPD Alliance）より日本国内で配布する許可を得て公開しています（2023年12月）。

## 注意

本資料は一般的な心理教育資料であり、個別の診断・治療に代わるものではありません。
治療上の判断は主治医にご相談ください。
